...
game-ticker-get-info-text = Round ID: [color=white]#{$roundId}[/color]
                            Players: [color=white]{$playerCount}[/color]
                            Current Map: [color=white]{$mapName}[/color]
                            Current Gamemode: [color=white]{$gmTitle}[/color]
                            >[color=yellow]{$desc}[/color]
game-ticker-get-info-preround-text = Round ID: [color=white]#{$roundId}[/color]
                            Players: [color=white]{$playerCount}[/color] ([color=white]{$readyCount}[/color] {$readyCount ->
                                [one] is
                                *[other] are
                            } ready)
